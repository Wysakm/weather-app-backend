...
var place_routes_1 = require("./routes/place.routes");
var province_routes_1 = require("./routes/province.routes"); // เพิ่ม import นี้
...
app.use(express_1["default"].json()); // ต้องมีบรรทัดนี้
app.use(express_1["default"].urlencoded({ extended: true })); // ต้องมีบรรทัดนี้
...
app.use('/api/provinces', province_routes_1["default"]); // เพิ่มบรรทัดนี้
// Health check
