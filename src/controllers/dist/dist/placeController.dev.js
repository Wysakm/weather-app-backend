...
function () {
  function PlaceController() {
    var _this = this; // GET /api/places - ดึงข้อมูลสถานที่ทั้งหมด


    this.getAllPlaces = function (req, res) {
        ...
        return __generator(this, function (_e) {
          switch (_e.label) {
            case 0:
              ...
              return [4
              /*yield*/
              , Promise.all([prisma.place.findMany({
                where: where,
                include: {
                  place_type: true,
                  province: true,
    ...
    this.getPlaceById = function (req, res) {
      return __awaiter(_this, void 0, Promise, function () {
    ...
    this.createPlace = function (req, res) {
      return __awaiter(_this, void 0, Promise, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              if (!updateData.place_type_id) return [3
              /*break*/
              , 3];
              return [4
              /*yield*/
              , prisma.placeType.findUnique({
                where: {
                  id_place_type: updateData.place_type_id
                }
              })];
            ...
            case 3:
              if (!updateData.province_id) return [3
              /*break*/
              , 5];
              return [4
              /*yield*/
              , prisma.msProvince.findUnique({
                where: {
                  id_province: updateData.province_id
                }
              })];
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              hasRelatedData = existingPlace._count.posts > 0 || existingPlace._count.weather_data > 0 || existingPlace._count.aqi_data > 0;
    ...
    this.getNearbyPlaces = function (req, res) {
      return __awaiter(_this, void 0, Promise, function () {
...
exports.PlaceController = PlaceController; // Export instance for use in routes
